...
def main(dataset, model, verbose, shots, train_percentage):
    ...
    task_dict['task_name'] = f'07_fs_extraction_{shots}_{model}_output_feedback_run_0'
    ...
    with open('prompts/prompt_templates/07_few-shot_extraction_output_feedback/sys_extraction.txt',
              'r') as f:
        system_prompt_txt = f.read()

    with open('prompts/prompt_templates/07_few-shot_extraction_output_feedback/sys_review.txt',
              'r') as f:

...
from pieutils.preprocessing import update_task_dict_from_test_set, update_task_dict_from_train_set
...
def main(dataset, model, verbose):
    ...
    task_dict['task_name'] = f'01_zs_extraction_run_0'
    ...
    with open('prompts/prompt_templates/01_zero-shot_extraction/sys_extraction.txt',
              'r') as f:

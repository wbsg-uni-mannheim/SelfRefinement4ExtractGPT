...
def main(dataset, model, verbose, description_configuration, no_example_values, train_percentage):
    ...
    task_dict['task_name'] = f'05_zs_extraction_ex_val_{description_configuration}_desc_{no_example_values}_{model}_default_gpt4o_rewrite_desc_run_0'
    ...
    with open('prompts/prompt_templates/05_zero-shot_extraction_example_values_error_based_rewrite_desc/sys_extraction.txt',
              'r') as f:

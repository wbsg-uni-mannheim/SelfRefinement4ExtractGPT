...
def main(dataset, model, verbose, description_configuration, no_example_values, shots, train_percentage):
    ...
    task_dict['task_name'] = f'04a_fs_extraction_{shots}__ex_val_{description_configuration}_desc_{no_example_values}_run_0'
    ...
    with open('prompts/prompt_templates/04a_few-shot_extraction_example_values/sys_extraction.txt',
              'r') as f:
